...
const ResumenCompraDirecta = () => {
  ...
  const ultimoElemento = carrito[carrito.length - 1];
  const ultimoElementoComoArray = [ultimoElemento];
            ...
            <section className="mb-6 m-5">
              ...
              <div className="mx-10">
                {carrito.length === 0 ? (
                  ...
                  ultimoElementoComoArray.map((producto) => (
...
export default ResumenCompraDirecta;
